...
public static class SEPath{
	...
	public const string CURSOR10         = "SE/cursor10";
	public const string DECISION13       = "SE/decision13";
	...
	public const string SE_STEAGE_SELECT = "SE/タイトル演出/ボタン決定音/効果音ラボ/SE_SteageSelect";
