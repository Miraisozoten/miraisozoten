...
// 必要なコンポーネントの列記
	...
	public class UnityChanControlScriptWithRgidBody : MonoBehaviour
	{
        ...
        void FixedUpdate()
        {
            ...
            //    velocity = velocity.normalized * backwardSpeed * Time.fixedDeltaTime;
            //}
            //else if (v > 0.1 || h > 0.1 || h < -0.1)
            //{
            //    //velocity *= forwardSpeed;       // 移動速度を掛ける
            //    velocity = velocity.normalized * forwardSpeed * Time.fixedDeltaTime;
            //}
            velocity = velocity.normalized * forwardSpeed * Time.fixedDeltaTime;
            ...
            //transform.position += cameraObject.transform.rotation.y * velocity;
